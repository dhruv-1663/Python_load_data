...
def raw_data_14_insert(data_url_14,db_url):
    ...
    df1.to_sql("test_table1",db_url,index=False,if_exists='replace')
...
def raw_data_15_insert(data_url_15,db_url):
    ...
    df2.to_sql("test_table3",db_url,index=False,if_exists='replace')
...
def lookup_insert(data_url_lookup,db_url):
    ...
    df_lookup.to_sql("test_table2_lookup",db_url,index=False,if_exists='replace')
